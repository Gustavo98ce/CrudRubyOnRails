...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { placa: @veiculo.placa, renavam: @veiculo.renavam } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { placa: @veiculo.placa, renavam: @veiculo.renavam } }
